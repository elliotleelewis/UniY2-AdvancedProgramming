...
class Person implements Serializable
{
	...
	/**
	 * @return {@link Person} object represented as an ArrayList.
	 */
	public ArrayList<Pair<String, String>> serialize()
	{
		ArrayList<Pair<String, String>> out = new ArrayList<>();
		out.add(new Pair<>("name", getName()));
		out.add(new Pair<>("gender", String.valueOf(getGender())));
		out.add(new Pair<>("natInscNo", getNatInscNo()));
		out.add(new Pair<>("dob", getDob()));
		out.add(new Pair<>("address", getAddress()));
		out.add(new Pair<>("postcode", getPostcode()));
		return out;
	}
	/**
